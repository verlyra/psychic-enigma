                        ...
                        <tr class="font-bold border-b border-gray-200">
                            ...
                            <td class="py-4">
                                ...
                                <% if(!isMe) { %>
                                    ...
                                    <a href="users.jsp?action=delete&id=<%= rs.getInt("id") %>" class="text-red-500 hover:text-red-700 font-[900] uppercase text-sm" onclick="return confirm('Hapus user ini?');">DELETE</a>
                                <% } %>
                            </td>
                        </tr>
                        <%      }
    ...
    <div id="editModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center p-4">
        <div class="bg-black p-3 w-full max-w-lg brutal-shadow">
            <div class="bg-white border-[4px] border-black p-8 relative">
                ...
                <form action="users.jsp?action=edit" method="POST" class="grid grid-cols-1 gap-6 mt-6">
