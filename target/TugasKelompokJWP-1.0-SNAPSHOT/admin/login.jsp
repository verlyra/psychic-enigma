        ...
        try {
            ...
            if (rs.next()) {
                ...
                if ("admin".equals(role)) {
                    ...
                    errorMsg = "Akses ditolak! Hanya admin yang diizinkan.";
                }
            } else {
...
<head>
    ...
    <title>VEND.IO - Admin Login</title>
    <!-- Tailwind CDN -->
...
<body class="min-h-screen flex items-center justify-center p-4">
    ...
    <div class="bg-white border-[4px] border-black p-10 w-full max-w-[400px] neubrutalism-card">
        ...
        <div class="flex flex-col items-center mb-10">
            ...
            <h1 class="text-4xl font-[900] italic tracking-tighter text-black mb-1">VEND.IO ADMIN</h1>
        ...
        <div class="mt-10 text-center space-y-2">
            ...
            <p class="font-bold text-xs"><a href="../index.jsp" class="text-blue-600 underline">Back to Store</a></p>
        </div>
    </div>
